...
namespace Castle.MonoRail.Views.AspView.Tests.HttpBasedIntegrationTests.LegacyRegressionTests
{
    ...
    [TestFixture]
	public class ViewComponentsTestFixture : BaseHttpBasedIntegrationTestFixture
    {
        [Test]
...
Hello from SimpleViewComponent
I was supposed to be rendered after the viewcomponent";
		...
		public void ViewComponentWithBodyWorks()
		{
			#region expected
			string expected = @"A simple viewcomponent, without a body and sections
<b>I was supposed to be rendered in the viewcomponent</b>
I was supposed to be rendered after the viewcomponent";
			#endregion
...
This text should be rendered right after text b.
    ...
    <div>
		<h1>Under me should appear the contents of a CaptureFor component, with id=""capturedContent""</h1>
			...
			This content should be rendered in the captured-for place holder
			<b>Bolded, yet still in the captured-for place holder</b>
...
<b>I should be bold, some variable textand within a BoldViewComponent</b>
