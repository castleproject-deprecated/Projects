...
namespace Castle.MonoRail.Views.AspView
{
	...
	public class AspViewCompilerOptions
	{
		...
		private string _referencesPath = null;
		private string _generatedAssemblyNamePrefix = null;
		...
		public AspViewCompilerOptions(
			...
			string generatedAssemblyNamePrefix,
			...
			: this()
		{
			...
			if (!string.IsNullOrEmpty(referencesPath)) _referencesPath = referencesPath;
			if (!string.IsNullOrEmpty(generatedAssemblyNamePrefix)) _generatedAssemblyNamePrefix = generatedAssemblyNamePrefix;
		...
		/// <summary>
		/// Location of the references, if not "bin".
		/// </summary>
		public string ReferencesPath
		{
			get { return _referencesPath; }
			set { _referencesPath = value; }
		}
		/// <summary>
		/// Optional prefix for the generated CompiledViews assembly name.
		/// </summary>
		public string GeneratedAssemblyNamePrefix
		{
			get { return _generatedAssemblyNamePrefix; }
			set { _generatedAssemblyNamePrefix = value; }
		}
		/// <summary>
