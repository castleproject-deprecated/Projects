...
namespace Castle.ActiveWriter
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides ActiveWriter files
	/// The implementation is done in ActiveWriterDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class ActiveWriterDirectiveProcessor : ActiveWriterDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public ActiveWriterDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides ActiveWriter files
	/// </summary>
	public class ActiveWriterDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string ActiveWriterDirectiveProcessorName = "ActiveWriterDirectiveProcessor";
		...
		/// </summary>
		private const string supportedDirectiveName = "ActiveWriter";
		...
		/// Constructor
		/// </summary>
		public ActiveWriterDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return ActiveWriterDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					if (!oneTimeCodeGenerated && global::System.IO.File.Exists(Host.TemplateFile))
					{
						...
						declaration = new global::System.CodeDom.CodeVariableDeclarationStatement(typeof(string), "templatePath", new global::System.CodeDom.CodePrimitiveExpression((string)(Host.TemplateFile)));
						resolver.Statements.Add(declaration);
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("ActiveWriterDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
		...
		protected override void PostProcessArguments(string directiveName, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				requiresArguments[requiresFileParameter] = Host.ResolvePath(requiresArguments[requiresFileParameter]);
			}
		}
