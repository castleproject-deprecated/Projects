...
namespace Castle.ActiveWriter
{
	...
	internal partial class ManyToOneRelationshipConnectAction : DslDiagrams::ConnectAction
	{
		...
		{
			if (MouseDownHitShape == null && currentCursor != global::System.Windows.Forms.Cursors.No)
			{
				DslDiagrams::DiagramHitTestInfo hitTestInfo = new DslDiagrams::DiagramHitTestInfo(diagramClientView);
				Diagram.DoHitTest(mousePosition, hitTestInfo);
		...
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				connectionTypes = new DslDiagrams::ConnectionType[] { new ManyToOneRelationshipConnectionType() };
			}
	...
	internal partial class ManyToManyRelationshipConnectAction : DslDiagrams::ConnectAction
	{
		...
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			if(connectionTypes == null)
			{
				connectionTypes = new DslDiagrams::ConnectionType[] { new ManyToManyRelationshipConnectionType() };
			}
	...
	internal partial class OneToOneRelationshipConnectAction : DslDiagrams::ConnectAction
	{
		...
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			if(connectionTypes == null)
			{
				connectionTypes = new DslDiagrams::ConnectionType[] { new OneToOneRelationshipConnectionType() };
			}
	...
	internal partial class NestedRelationshipConnectAction : DslDiagrams::ConnectAction
	{
		...
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			if(connectionTypes == null)
			{
				connectionTypes = new DslDiagrams::ConnectionType[] { new NestedRelationshipConnectionType() };
			}
	...
	internal partial class InheritanceRelationshipConnectAction : DslDiagrams::ConnectAction
	{
		...
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			if(connectionTypes == null)
			{
				connectionTypes = new DslDiagrams::ConnectionType[] { new InheritanceRelationshipConnectionType() };
			}
