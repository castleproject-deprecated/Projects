...
namespace Castle.ActiveWriter
{
	...
	/// </summary>
	internal partial class ActiveWriterDocView : ActiveWriterDocViewBase
	{
		/// <summary>
		/// Constructs a new ActiveWriterDocView.
		/// </summary>
		public ActiveWriterDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ActiveWriterDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new ActiveWriterDocView.
		/// </summary>
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.ActiveWriterDiagramMenu;
			}
		}
