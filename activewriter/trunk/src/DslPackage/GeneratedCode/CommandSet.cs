...
namespace Castle.ActiveWriter
{
	...
	{
		/// <summary>
		/// Constructs a new ActiveWriterCommandSet.
		/// </summary>
		public ActiveWriterCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class ActiveWriterCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new ActiveWriterCommandSetBase.
		/// </summary>
		protected ActiveWriterCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		{
			ActiveWriterExplorerToolWindow explorer = this.ActiveWriterExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentActiveWriterDocData != null && this.CurrentActiveWriterDocData.Store != null)
			{
				...
				this.CurrentActiveWriterDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected ActiveWriterDocData CurrentActiveWriterDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as ActiveWriterDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected ActiveWriterDocView CurrentActiveWriterDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as ActiveWriterDocView;
			}
		}
		...
		/// </summary>
		protected ActiveWriterExplorerToolWindow ActiveWriterExplorerToolWindow
		{
			get
			{
				ActiveWriterExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(ActiveWriterExplorerToolWindow), true) as ActiveWriterExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				ActiveWriterExplorerToolWindow explorerWindow = this.ActiveWriterExplorerToolWindow;
