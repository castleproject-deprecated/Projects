...
namespace Castle.Tools.CodeGenerator.Services.Generators.RouteMapGeneration
{
	...
	{
		public StaticRouteCreator(string @namespace, ISourceGenerator sourceGenerator, INamingService namingService,
		                          StaticRouteTreeNode node, CodeTypeDeclaration routeDefinitions, CodeTypeDeclaration routes)
		...
		{
			var expressions = base.GetRouteDefinitionBaseConstructorArgs();
