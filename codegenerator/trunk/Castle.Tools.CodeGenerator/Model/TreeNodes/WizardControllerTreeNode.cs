...
namespace Castle.Tools.CodeGenerator.Model.TreeNodes
{
	...
	public class WizardControllerTreeNode : ControllerTreeNode
	{
		...
		{
			WizardStepPages = wizardStepPages;
		}

		public string[] WizardStepPages { get; set; }

		public override string ToString()
		{
			if (WizardStepPages.Length == 0)
				return base.ToString();

			var types = WizardStepPages.Aggregate(string.Empty, (seed, page) => { seed += page + ","; return seed; }).TrimEnd(',');
