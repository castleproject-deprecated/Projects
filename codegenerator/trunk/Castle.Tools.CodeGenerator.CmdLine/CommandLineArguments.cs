...
namespace CommandLine
{
	...
	public sealed class Parser
	{
		...
		{
			[ArgumentAttribute(ArgumentType.AtMostOnce, ShortName = "?")] public bool help = false;
		}
		...
		[DllImport("kernel32.dll", EntryPoint = "GetConsoleScreenBufferInfo", SetLastError = true, CharSet = CharSet.Auto,
			CallingConvention = CallingConvention.StdCall)]
