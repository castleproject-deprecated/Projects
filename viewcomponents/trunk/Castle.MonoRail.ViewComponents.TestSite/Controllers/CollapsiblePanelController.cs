...
namespace Castle.MonoRail.ViewComponents.TestSite.Controllers
{
    ...
    public class CollapsiblePanelController : SmartDispatcherController
	{
		public void Index()
		{
            PropertyBag["loremIpsumText"] = @"
                ...
                dolorem eum fugiat, quo voluptas nulla pariatur? [33] At vero eos et accusamus et 
                iusto odio dignissimos ducimus, qui blanditiis praesentium voluptatum deleniti atque 
                corrupti, quos dolores et quas molestias excepturi sint, obcaecati cupiditate non 
