...
namespace Castle.Tools.SQLQueryGenerator
{
	...
	class SQLQueryGeneratorException : ApplicationException
	{
...
{4}
		...
		{
			content.Insert(0, @"// Copyright 2008 Ken Egozi http://www.kenegozi.com/blog
// 
// Licensed under the Apache License, Version 2.0 (the ""License"");
// you may not use this file except in compliance with the License.
// You may obtain a copy of the License at
...
");
		...
		static void AddGeneratedByToolNotice(StringBuilder content)
		{
			Assembly assembly = Assembly.GetExecutingAssembly();
			string title = ((AssemblyTitleAttribute)AssemblyTitleAttribute.GetCustomAttribute(
				assembly, typeof (AssemblyTitleAttribute))).Title;

			string version = ((AssemblyFileVersionAttribute)AssemblyFileVersionAttribute.GetCustomAttribute(
				assembly, typeof(AssemblyFileVersionAttribute))).Version;

			content.Insert(0, string.Format(@"/*
This file was generated by {0} version {1}
At {2}
*/
", title, version, DateTime.Now));
		}
