package Castle.FlexBridge.Flash.Common
{
	...
	[Event(name="result", type="Castle.FlexBridge.Flash.Common.AsyncTaskEvent")]
	[Event(name="error", type="Castle.FlexBridge.Flash.Common.AsyncTaskEvent")]
	[Event(name="statusChange", type="Castle.FlexBridge.Flash.Common.AsyncTaskEvent")]
