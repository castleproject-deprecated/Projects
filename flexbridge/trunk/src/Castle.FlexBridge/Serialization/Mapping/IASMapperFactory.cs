...
{
    /// <summary>
    /// An ActionScript mapper factory provides instances of <see cref="IASSourceMapper" />
    /// and <see cref="IASTargetMapper" /> that can perform certain mappings on demand.
    /// </summary>
    public interface IASMapperFactory
    {
        /// <summary>
        ...
        IASTargetMapper GetASTargetMapper(ASTargetMappingDescriptor descriptor);
        ...
        /// <returns>The ActionScript target mapper, or null if no compatible mapper can be obtained by this factory</returns>
        IASSourceMapper GetASSourceMapper(ASSourceMappingDescriptor descriptor);
    }
}
